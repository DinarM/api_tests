...
class TestGetUniqueHarvestTechnologiesFromField:
    def test_get_unique_harvest_technologies_from_field_success(
        ...
        response = plastilin_db_api.get_unique_harvest_technologies_from_field(
            token=token,
            year_id=year_id,
        )
        ...
        schema_validator.assert_valid_response(
            response_data,
            'plastilin_db/get_unique_harvest_technologies_from_field/get_response.json'
        )