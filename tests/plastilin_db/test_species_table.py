...
class TestSpeciesTableCreate:
    ...
    def test_create_species_table_max_length(self, get_token, plastilin_db_api, schema_validator, data_helper):
        ...
        response = plastilin_db_api.create_species_table(
            token=token,
            english_name=max_length_string,
            russian_name=max_length_string
        )
...
class TestSpeciesTableGet:
    ...
    def test_get_species_table_list(self, get_token, plastilin_db_api, schema_validator, api_helper):
        """
