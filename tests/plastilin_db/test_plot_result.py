...
from utils.api.constants import PLOT_RESULT_FIELDS, PLOT_RESULT_MODIFICATIONS
...
class TestPlotResultCreate:
    ...
    def test_plot_result_update(self, get_token, plastilin_db_api, data_helper):
        ...
        plot_data = data_helper.update_plot_result_data(
            plot_data=plot_data,
            modifications=PLOT_RESULT_MODIFICATIONS['add_column'],
        )
        excel_file, filename = data_helper.create_plot_result_excel(plot_data=plot_data)
