...
class TestUserGroupsWithFieldsGet:
    ...
    """
    def test_get_user_groups_with_fields_success(self, get_token, plastilin_db_api, schema_validator):
        """
        ...
        schema_validator.assert_valid_response(
            response_data, 
            'plastilin_db/user_groups_with_fields/list_response.json'
        )
...
class TestUserGroupsWithFieldsGetPermissions:
    ...
    def test_get_user_groups_with_fields_permissions(self, plastilin_db_api, schema_validator, role, expected_status, get_token):
        """
