...
class TestUsersByCompanyIdGet:
    ...
    def test_get_users_by_company_id_success(self, get_token, users_api, schema_validator, data_helper):
        """
        ...
        schema_validator.assert_valid_response(
            response_data, 
            'users/users_by_company_id/list_response.json'
        )
...
class TestUsersByCompanyIdGetPermissions:
    ...
    def test_get_users_by_company_id_permissions(self, users_api, role, expected_status, get_token, data_helper):
        """
