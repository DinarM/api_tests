...
class UsersGroupsApi(BaseAPI):
    ...
    def create_users_groups(self, token: str, name: str, read: Optional[bool] = None, write: Optional[bool] = None) -> APIResponse:
    ...
    def get_users_groups(self, token: str) -> APIResponse:
        headers = self.headers.copy()
        headers['Authorization'] = token
    ...
    def update_users_group(self, token: str, group_id: int, name: str, read: Optional[bool] = None, write: Optional[bool] = None) -> APIResponse:
        headers = self.headers.copy()
        headers['Authorization'] = token
        payload = {
            'name': name,
    ...
    def invite_user_to_group(self, token: str, user_group_id: int, user_id: int) -> APIResponse:
        headers = self.headers.copy()
        headers['Authorization'] = token
        payload = { 
